# Модуль ИИ-модерации объявлений — план разработки

**Стек:** NestJS · Prisma · Redis (уже есть) · BullMQ · YandexGPT 5.1 (текст) · YandexGPT Pro multimodal (фото)  
**API ключ:** уже получен, хранить в `.env` как `YANDEX_API_KEY`
