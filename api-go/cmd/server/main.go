...
func main() {
	...
	prodSvc := service.NewProductService(prodRepo, s3c, userSvc, statSvc)
	...
	dealSvc := service.NewDealService(cfg, dealRepo, chatRepo, paySvc, reservationRepo, cdekSvc, userRepo)
